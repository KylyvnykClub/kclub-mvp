...
This project is indexed by GitNexus as **kclub-mvp** (5019 symbols, 11586 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
