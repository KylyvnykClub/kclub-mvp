...
Репозиторий — монорепо на pnpm/Turborepo с двумя Next.js приложениями. Нужно **два отдельных Vercel-проекта**, оба смотрят на один и тот же GitHub-репозиторий, но с разным Root Directory:
