...
import { Color, Scene, Fog, Group, Vector3 } from 'three';
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    ...
    globeRef.current
      ...
      .arcColor((arc: unknown) => (arc as { color: string }).color)
...
export function hexToRgb(hex: string) {
  ...
  const normalizedHex = hex.replace(shorthandRegex, function (_match, r, g, b) {
    return r + r + g + g + b + b;
  });
