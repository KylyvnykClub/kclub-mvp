...
export default async function BusinessDetailPage({ params }: Params) {
  ...
  return (
    <article className="bg-surface-muted/40 min-h-screen">
      <script
      ...
      {/* Hero */}
      <div className="mx-auto w-full max-w-7xl overflow-hidden border border-border bg-surface shadow-sm">
        <header>
          <div className="grid lg:grid-cols-12">
            {/* Cover / Logo area */}
            <div className="relative flex min-h-72 overflow-hidden border-b border-border bg-background lg:col-span-5 lg:min-h-[32rem] lg:border-b-0 lg:border-r">
              {business.coverImageUrl ? (
                ...
                <div className="flex w-full items-center justify-center bg-[radial-gradient(circle_at_center,hsl(var(--muted))_0,transparent_68%)] p-8">
                  {business.logoUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img
            ...
            <div className="flex flex-col justify-center p-6 sm:p-10 lg:col-span-7 lg:p-14">
              ...
              <h1 className="mt-5 max-w-xl text-4xl font-light leading-[0.95] tracking-tight text-foreground sm:text-5xl lg:text-6xl">
                {business.name}
              </h1>
        ...
        {/* Main Content */}
        <section className="border-t border-border px-6 py-10 sm:px-10 lg:px-14 lg:py-14">
          <div className="grid gap-8 lg:grid-cols-12 lg:gap-12">
            ...
            <div className="min-w-0 lg:col-span-8">
              ...
              {business.memberDiscountPercent ? (
                <div className="border-accent/30 mt-8 border-y py-6 sm:py-8">
            ...
            <aside className="min-w-0 lg:col-span-4 lg:border-l lg:border-border lg:pl-10">
              <div>
