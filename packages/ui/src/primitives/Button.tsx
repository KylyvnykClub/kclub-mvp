...
type ButtonColor = 'primary' | 'secondary' | 'brand' | 'brand-secondary' | 'destructive' | 'ghost';
  ...
  return cn(
    'focus-visible:ring-focus focus-visible:ring-offset-focus relative inline-flex items-center justify-center font-semibold uppercase transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
    {
      'bg-primary text-primary-foreground border border-transparent shadow-sm hover:opacity-90':
        color === 'primary',
      'border border-border bg-secondary text-secondary-foreground hover:bg-surface-muted shadow-sm':
        color === 'secondary',
      ...
      'bg-red-600 text-white border border-transparent shadow-sm hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700': 
        color === 'destructive',
      'text-muted-foreground hover:text-foreground border border-transparent': 
        color === 'ghost',
    },
    {
      'px-4 py-2.5 text-[10px] tracking-[0.2em] rounded-md': size === 'sm',
      'px-5 py-3 text-xs tracking-[0.24em] rounded-md': size === 'md',
      'px-6 py-3.5 text-sm tracking-[0.26em] rounded-lg': size === 'lg',
    },
    fullWidth && 'w-full',
    className,
  );
