...
export const MEMBER_API_ROUTES = {
  ...
  BUSINESS_MEDIA: `${API_BASE_PATH}/businesses/:id/media`,
  BUSINESS_DOCUMENTS: `${API_BASE_PATH}/businesses/:id/documents`,
  ...
  BUSINESS_INTRODUCTION_COMPLETE: `${API_BASE_PATH}/me/business/introductions/:id/complete`,
...
export const ADMIN_API_ROUTES = {
  ...
  BUSINESS_DOCUMENT_APPROVE: `${ADMIN_API_BASE_PATH}/businesses/:id/documents/:documentId/approve`,
  BUSINESS_DOCUMENT_REJECT: `${ADMIN_API_BASE_PATH}/businesses/:id/documents/:documentId/reject`,
